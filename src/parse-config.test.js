...
describe('parse(): Load and parse yml config as json', () => {
  test('Minimum', async () => {
    const file = path.join(__dirname, '../mocks/minimum.yml')
  ...
  test('Kitchen sink', async () => {
    const file = path.join(__dirname, '../mocks/kitchen-sink.yml')
    expect(await parse(file)).toMatchInlineSnapshot(`
      Object {
        "breakpoints": Object {
          "large": "768px",
